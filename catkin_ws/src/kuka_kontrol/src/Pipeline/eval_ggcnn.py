...
sys.argv.extend(['--network', "/home/larissa/MastersProject/catkin_ws/src/kuka_kontrol/src/Pipeline/training_network/models/221204_2038_new_dataset_depth_300/epoch_25_iou_0.00"])
...
sys.argv.extend(['--use-rgb', "0"])
sys.argv.extend(['--n-grasps', "1"])
sys.argv.extend(['--iou-eval'])
sys.argv.extend(['--vis'])
# sys.argv.extend(['--epochs', "50"])
# sys.argv.extend(['--outdir', "training_network/models"])
# sys.argv.extend(['--logdir', "training_network/log"])
# sys.argv.extend(['--description', "default_jacquard_depth"])
